...
def parse_args():
    ...
    parser.add_argument('--datatype', default='cancer_lgg_val_data.pkl', help="datatype")

    parser.add_argument('--model_save', type=str,
                        default='Experimental_results/model_save/',
                        help='models are saved here')
    parser.add_argument('--results', type=str,
                        default='Experimental_results/results/',
                        help='results are saved here')

    parser.add_argument('--exp_name', type=str, default='Survival prediction',
    ...
    parser.add_argument('--lr', default=1.2e-4, type=float, help='5e-4 for Adam | 1e-3 for AdaBound')
    ...
    parser.add_argument('--weight_decay', default=1e-5, type=float,
                        help='Used for Adam. L2 Regularization on weights. '
                             'I normally turn this off if I am using L1. You should try')
...
def print_options(parser, opt):
    ...
    for k, v in sorted(vars(opt).items()):
        ...
        if v != default:
            comment = '/t[default: %s]' % str(default)
